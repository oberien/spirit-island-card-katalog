...
namespace DB {
    ...
    export const CARDS = [
        ...
        new PowerCard(ProductSet.NatureIncarnate, Unique.HearthVigil, "Favors of Story and Season", 1, Speed.Fast, null, TargetSpirit.Another,
            ...
            "Target Spirit may Gather up to 3 Dahan into one of their lands. If they have at least 3 Dahan among their lands, they gain 10Energy and may Reclaim 1 Power Card instead of discarding it at the end of turn."),
