...
namespace DB {
    ...
    export const CARDS = [
        ...
        new Card(Unique.LightngingsSwiftStrike, "Lightning's Boon", 1, Speed.Fast, null, TargetSpirit.Any,
            [Elements.Fire, Elements.Air], "Rocky Hammer",
        ...
        new Card(CardType.BasegameMajor, "Paralyzing Fright", 4, Speed.Fast, new Ranges(Source.SacredSite, 1), LandAny,
        ...
        // Promo
        // Uniques
        new Card(Unique.HeartOfTheWildfire, "Flash-Fires", 2, Speed.Slow, new Ranges(Source.Presence, 1), LandAny,
            [Elements.Fire, Elements.Air], "Nolan Nasser",
            "1 Fear. 1 Damage. -If you have- 2 Air: This Power is Fast."),
        new Card(Unique.HeartOfTheWildfire, "Asphyxiating Smoke", 2, Speed.Slow, new Ranges(Source.SacredSite, 2), LandAny,
            [Elements.Fire, Elements.Air, Elements.Plant], "Nolan Nasser",
            "1 Fear. Destroy 1 Town. Push 1 Dahan."),
        new Card(Unique.HeartOfTheWildfire, "Flame's Fury", 0, Speed.Fast, null, TargetSpirit.Any,
            [Elements.Sun, Elements.Fire, Elements.Plant], "Nolan Nasser",
        ...
        new Card(Unique.HeartOfTheWildfire, "Threatening Flames", 0, Speed.Fast, new Ranges(Source.Presence, 0), [TargetProperty.Blight, TargetProperty.Invaders],
            [Elements.Fire, Elements.Plant], "Nolan Nasser",
        ...
        new Card(Unique.SerpentSlumberingBeneathTheIsland, "Gift of the Primordial Deeps", 1, Speed.Fast, null, TargetSpirit.Another,
        ...
        new Card(Unique.SerpentSlumberingBeneathTheIsland, "Gift of Flowing Power", 1, Speed.Fast, null, TargetSpirit.Another,
        ...
        new Card(Unique.SerpentSlumberingBeneathTheIsland, "Absorb Essence", 2, Speed.Fast, null, TargetSpirit.Another,
        ...
        new Card(Unique.SerpentSlumberingBeneathTheIsland, "Elemental Aegis", 1, Speed.Fast, new Ranges(Source.Presence, 0), LandAny,
