...
for i in range(len(files)):
    os.rename(files[i], names[i] + ".jpg")

# files = glob.glob("*-00*_small.webp");
# if len(files) != len(names):
    # print("RIP")
    # exit()
...
# files.sort();
# for i in range(len(files)):
    # os.rename(files[i], names[i] + ".webp")
